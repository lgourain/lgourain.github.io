...
async function generateImageData({
  ...
  if (layout === `fullWidth`) {
    ...
    args.breakpoints = ((_args$breakpoints = args.breakpoints) === null || _args$breakpoints === void 0 ? void 0 : _args$breakpoints.length) ? args.breakpoints : DEFAULT_BREAKPOINTS;
  }
